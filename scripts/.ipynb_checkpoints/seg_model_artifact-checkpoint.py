...
tissue = '840031_0055-median_r_50'
...
#     '/Volumes/My Book/cylinter_input/topacio/' +
#     'output/checkpoints/dnaIntensityCutoff.parquet')

# sample_data = data[data['Sample'] == issue]
...
dna = single_channel_pyramid(
    f'/Volumes/My Book/cylinter_input/topacio/tif/{tissue}.ome.tif',
    channel=0
    )

# read segmentation outlines
seg = single_channel_pyramid(
    f'/Volumes/My Book/cylinter_input/topacio/seg/{tissue}.ome.tif',
    channel=0
    )
